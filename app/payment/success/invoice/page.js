...
const Invoice = () => {
  ...
  const getReservationByID = async () => {
    try {
      ...
      console.log(`${process.env.NEXT_PUBLIC_BASE_URL}/reservations?reserve_id=${order_id}`)
    ...
    <>
     {
      ...
      <section className="bg-black">
        <div className="max-w-5xl pt-5 bg-white">
          <article className="overflow-hidden" id='invoice-container'>
            <div className="bg-[white] rounded-b-md">
              <div className="px-9">
                <div className="space-y-2 text-slate-700">
                  <img className="object-cover h-[120px] -ml-5" src="/logo-orange.png" />
              ...
              <div className="px-9 mt-7">
                <div className="flex w-full">
                  ...
                  <div className="text-sm font-light text-slate-500">
                    <p className="text-sm font-normal text-slate-700">Invoice Date</p>
              ...
              <div className="px-9">
                <div className="flex flex-col mx-0 mt-5">
                  ...
                  <thead>
                    <tr>
                    <th scope="col" className="py-3.5 pl-4 pr-3 text-left text-sm text-slate-700 sm:pl-6 md:pl-0 font-semibold">
                      Description
                    </th>
                    ...
                    <th scope="col" className="py-3.5 pl-3 pr-4 text-right text-sm font-semibold text-slate-700 sm:pr-6 md:pr-0">
                      Amount
                    </th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <td className="py-4 pl-4 pr-3 text-xs sm:pl-6 md:pl-0">
                      <div className="font-medium text-slate-700 text-sm">{data.location}</div>
                  ...
                  <tfoot>
                    <tr>
                    <th scope="row" colspan="3" className="hidden pt-0 pl-6 pr-3 text-sm font-light text-right text-slate-500 sm:table-cell md:pl-0">
                      Subtotal
                    </th>
              ...
              <div className="px-9 py-5">
                <div className="border-t pt-5 border-slate-200">
                  ...
                  <p className='text-justify'>
                    Simpan bukti pembayaran ini untuk dibawa saat ingin bermain di Ikuzo Playstation sebagai bukti telah melakukan pemesanan reservasi tempat/layanan di Ikuzo Playstation! Ditunggu kehadiranmu!
                  </p>
                  </div>
                </div>
              </div>
          ...
          <div className='px-9 flex flex-col gap-5 mb-10'>
                <Button onClick={downloadInvoice} className="bg-orange rounded-lg px-5 -mt-2 py-6 text-sm font-jakarta hover:bg-orange w-full font-medium">
                    Download
                </Button>
                <Link href={'/'}>
