    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className={`flex items-center justify-center gap-1`}>
          ...
          <Button
            variant="outline"
            className=" border border-yellow-500 bg-yellow-500 bg-opacity-10 text-xs  text-yellow-500"
          >
          ...
          <form action="" method="post">
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button
                  variant="outline"
                  className="ml-auto border border-red-500 bg-red-500 bg-opacity-10 text-xs text-red-500"
                >
