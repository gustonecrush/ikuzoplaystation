    ...
    <>
      <section className="flex flex-col h-full w-full scroll-smooth overflow-x-hidden">
          ...
          <div className="flex flex-col relative items-center justify-center bg-black bg-opacity-35">
            ...
            <FadeContainer>
              <div className="absolute flex flex-col gap-2 left-1/2 transform -translate-x-1/2 w-full md:w-1/2 top-1/2 z-40 -translate-y-1/2 items-center justify-center">
                <h1 className="text-white font-extrabold font-montserrat text-[3.7rem] leading-none text-center md:text-[6rem] md:mt-16">
                ...
                <p className="text-white font-normal text-center text-base md:text-lg">
                  ...
                  friends, or as a couple. Feel it and tell the world how
                  excited it was!
                </p>
        ...
        <SlideContainer>
          ...
          >
            <Image
              className="-z-50 w-full h-[75vh] object-cover bg-opacity-10"
              alt="Facilites Image"
              width={0}
              height={0}
            ...
            <FadeContainer>
              <div className="absolute w-full md:w-1/2 px-2 flex flex-col gap-2 left-1/2 transform -translate-x-1/2 top-1/2 z-40 -translate-y-1/2 items-center py-12 pt-16">
                <h1 className="text-white font-extrabold font-montserrat text-[3.7rem] leading-none text-center md:text-[6rem] md:mt-16">
                  PRIVATE ROOM,{' '}
                  <span className="text-orange">REGULAR SPOT</span> , AND
                  FACILITIES
                </h1>
                <p className="text-white font-normal text-center text-base md:text-lg">
                  suasana "Homey" saat bermain pada Gaming Space Keluarga No. 1
                  di Kota Bandung. Maksimalkan pengalamanmu dengan beragam
                  fasilitas seru pelayan terbaik yang bisa kamu dapatkan !
                </p>

                <Link href={'/reservation'} className="">
                  <Button
                    variant="outline"
                    className={`bg-orange text-white border-orange py-6 text-base mt-4 mb-20 w-fit px-10 relative font-semibold duration-1000`}
                  >
                    RESERVE NOW
                  </Button>
                </Link>
        ...
        <SlideContainer>
          <div className="flex bg-black bg-opacity-35 flex-col relative items-center justify-center">
            <Image
              className="-z-50 w-full h-[70vh] object-cover bg-opacity-10"
              alt="Facilites Image"
              width={0}
              height={0}
              title="Facilities Image"
            ...
            <FadeContainer>
              <div className="absolute w-full md:w-1/2 px-2 flex flex-col gap-2 left-1/2 transform -translate-x-1/2 top-1/2 z-40 -translate-y-1/2">
                <h1 className="text-white font-extrabold font-montserrat text-[3.3rem] leading-none text-center md:text-[6rem] md:mt-16 px-1">
        ...
        <div className="flex flex-col gap-2 items-center justify-center py-5 bg-white w-full h-fit z-20">
          ...
          {/* <Link href={'/reservation'} className="">
            <Button
              variant="outline"
              className={`bg-orange text-white border-orange py-6 text-base -mt-4 w-fit px-10 relative font-semibold animate-bounce duration-1000`}
            >
              RESERVE NOW
            </Button>
          </Link> */}
