          ...
          <Slide>
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                className="border border-black rounded-full px-3 py-2 active:border-orange focus:border-orange focus:outline-orange"
                required
              />
            </div>
          </Slide>
          ...
          <Slide delay={6} duration={1200}>
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                placeholder="Masukkan nomor Whatsapp"
                className="border border-black rounded-full px-3 py-2 active:border-orange focus:border-orange focus:outline-orange w-full bg-white"
                min={currentDate}
                max={maxDate}
                required
              />
