    ...
    return (
        ...
        >
            <Link href={'/'} onClick={() => {
                ...
                setIsLoadingSearch(false)
                setCatalogTxt('')
            }} className='rounded-full  h-15 w-fit flex items-center justify-center p-2 bg-orange text-white text-xl'><IoArrowBack />
            </Link>
            <div className="w-full mt-10">
                <div className='mb-3'>
                    <h1 className='font-semibold text-2xl'>Search Catalog</h1>
                    <p className='text-gray-500 leading-none'>
                        Find the best games here and reserve yours in Ikuzoplaystation!
                    </p>
                </div>
